...
<body>
        ...
        <div id="container_slider">
            <div id="slider" class="slider"> <!--slider-->
                <div class="sli_section">
                    <img src="../IMG/guitaacus9/guita1.png" alt="" class="sli_img">
                </div>
                <div class="sli_section">
                    <img src="../IMG/guitaacus9/guita2.png" alt="" class="sli_img">
                </div>
                <div class="sli_section">
                    <img src="../IMG/guitaacus9/guita3.png" alt="" class="sli_img">
                </div>
                <div class="sli_section">
                    <img src="../IMG/guitaacus9/guita4.png" alt="" class="sli_img">
                </div>
            </div>
    ...
    <div id="description">
        <p id="descr">
            Desarrollado en los años 30, el L-00 fue un estándar de la industria durante muchos años. El L-00 Standard captura maravillosamente la herencia de esos primeros modelos ejemplares. Con un equilibrio perfecto, la L-00 tiene una proyección incomparable que no se encuentra en guitarras comparables de cuerpo pequeño.
        </p>
        <div id="specific">
            <ul>
                <li>
                ...
                <li>
                    <span>Controles</span>
                    <p>Volumen y control en controlador</p>
                </li>
            </ul>
        </div>
    </div>
    <div id="add">
        <form action="../PHP/agregar_carrito.php" method="post">
            <button name="ejecutarFuncion29" type="submit">Agregar al carrito  <i class="fa-solid fa-basket-shopping"></i></button>
        </form>   
    </div>
    </section>

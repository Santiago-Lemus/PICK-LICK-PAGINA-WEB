...
<body>
    ...
    <section id="content">
        <div id="tittle">
            <h1>Troy Sanders Jaguar® Bass</h1>
    ...
    <div id="thinks">
            <div id="container_slider">
                <div id="slider" class="slider"> <!--slider-->
                    <div class="sli_section">
                        <img src="../IMG/bass2/bass1.jpg" alt="" class="sli_img">
                    </div>
                    <div class="sli_section">
                        <img src="../IMG/bass2/bass2.jpg" alt="" class="sli_img">
                    </div>
                    <div class="sli_section">
                        <img src="../IMG/bass2/bass3.jpg" alt="" class="sli_img">
                    </div>
                    <div class="sli_section">
                        <img src="../IMG/bass2/bass4.jpg" alt="" class="sli_img">
                    </div>
                </div>
        ...
        <div id="contenide">
                ...
                <p class="infotext">Silverburst</p>
                ...
                <p id="infoprice">$8'499.000</p>
        </div>
    </div>
    <div id="description">
        <p id="descr">
            El gigante de metal Mastodon siempre ha sido liderado por el hábil trabajo del bajo pesado y rápido de Troy Sanders. Fender y Sanders se unieron para crear el aspecto y el sonido distintivo del Troy Sanders Jaguar Bass. Con su oscuramente seductor cuerpo y palal en Silverburst, su versátil electrónica con circuito doble no estándar, es un instrumento feroz cargado con sonido monstruoso, estilo y potencia.
        </p>
        <div id="specific">
            <ul>
                <li>
                ...
                <li>
                    <span>Pastillas</span>
                    <p>Custom Noiseless™ Single-Coil Jazz Bass®</p>
                </li>
            </ul>
        </div>
    </div>
    <div id="add">
        <form action="../PHP/agregar_carrito.php" method="post">
            <button name="ejecutarFuncion33" type="submit">Agregar al carrito  <i class="fa-solid fa-basket-shopping"></i></button>
        </form>   
    </div>
    </section>

...
<body>
    ...
    <div id="thinks">
        <div id="container_slider">
            <div id="slider" class="slider"> <!--slider-->
                <div class="sli_section">
                    <img src="../IMG/guitaelec10/guita1.png" alt="" class="sli_img">
                </div>
                <div class="sli_section">
                    <img src="../IMG/guitaelec10/guita2.png" alt="" class="sli_img">
                </div>
                <div class="sli_section">
                    <img src="../IMG/guitaelec10/guita3.png" alt="" class="sli_img">
                </div>
                <div class="sli_section">
                    <img src="../IMG/guitaelec10/guita4.png" alt="" class="sli_img">
                </div>
            </div>
        ...
        <div id="contenide">
                ...
                <p class="infotext">Heritage Cherry Sunburst</p>
                ...
                <p id="infoprice">$14'999.000</p>
        </div>
    </div>
    <div id="description">
        <p id="descr">
            La nueva Les Paul Standard vuelve al diseño clásico que la hizo relevante, tocada y amada, dando forma al sonido a través de generaciones y géneros musicales. Rinde homenaje a la era dorada de la innovación de Gibson y devuelve la autenticidad a la vida. La Les Paul Standard 50's tiene un cuerpo de caoba maciza con tapa de arce, un mástil redondeado de caoba estilo años 50 con diapasón de palisandro e incrustaciones trapezoidales. Está equipado con un ABR-1, el puente Tune-O-Matic de estilo clásico, cordal con barra de tope de aluminio, clavijero vintage de lujo con botones keystone y perillas de sombrero de copa dorado envejecido. Las pastillas calibradas Burstbucker 1 (cuello) y Burstbucker 2 (puente) están cargadas con imanes AlNiCo II, potenciómetros cónicos de audio y condensadores de gota naranja.
        </p>
        <div id="specific">
            <ul>
                <li>
    ...
    <div id="add">
        <form action="../PHP/agregar_carrito.php" method="post">
            <button name="ejecutarFuncion10" type="submit">Agregar al carrito  <i class="fa-solid fa-basket-shopping"></i></button>
        </form>   
    </div>
    </section>

...
<body>
    ...
    <section id="content">
        <div id="tittle">
            <h1>1965 Non-Reverse Firebird V w/ Vibrola</h1>
    ...
    <div id="thinks">
        <div id="container_slider">
            <div id="slider" class="slider"> <!--slider-->
                <div class="sli_section">
                    <img src="../IMG/guitaelec17/guita1.png" alt="" class="sli_img">
                </div>
                <div class="sli_section">
                    <img src="../IMG/guitaelec17/guita2.png" alt="" class="sli_img">
                </div>
                <div class="sli_section">
                    <img src="../IMG/guitaelec17/guita3.png" alt="" class="sli_img">
                </div>
                <div class="sli_section">
                    <img src="../IMG/guitaelec17/guita4.png" alt="" class="sli_img">
                </div>
            </div>
        ...
        <div id="contenide">
                ...
                <p class="infotext">Vintage Sunburst</p>
                <h2 class="infotittle">MATERIAL DEL DIAPASÓN</h2>
                <p class="infotext">Caoba Solida</p>
                <h2 class="infotittle">FABRICANTE</h2>
                <img src="../IMG/Gibson-Logo.png" alt="" id="infoimage">
                <p id="infoprice">$22'499.000</p>
        </div>
    </div>
    <div id="description">
        <p id="descr">
            La segunda versión del Firebird llevó la plataforma compensada a nuevos territorios sónicos. Con su construcción liviana de mástil fijo y la orientación invertida del mástil y el cuerpo, el '65 Firebird V se volvió amado y venerado por su funcionalidad y estilo. Esta recreación Custom Shop utiliza perfiles y métodos de construcción auténticos para proporcionar un instrumento de apariencia, sensación y sonido innegables.
        </p>
        <div id="specific">
            <ul>
                <li>
    ...
    <div id="add">
        <form action="../PHP/agregar_carrito.php" method="post">
            <button name="ejecutarFuncion16" type="submit">Agregar al carrito  <i class="fa-solid fa-basket-shopping"></i></button>
        </form>   
    </div>
    </section>

...
<body>
    ...
    <div id="thinks">
        <div id="container_slider">
            <div id="slider" class="slider"> <!--slider-->
                <div class="sli_section">
                    <img src="../IMG/guitaelec20/guita1.jpg" alt="" class="sli_img">
                </div>
                <div class="sli_section">
                    <img src="../IMG/guitaelec20/guita2.jpg" alt="" class="sli_img">
                </div>
                <div class="sli_section">
                    <img src="../IMG/guitaelec20/guita3.jpg" alt="" class="sli_img">
                </div>
                <div class="sli_section">
                    <img src="../IMG/guitaelec20/guita4.jpg" alt="" class="sli_img">
                </div>
            </div>
        ...
        <div id="contenide">
                ...
                <p class="infotext">White Blonde</p>
                ...
                <p id="infoprice">$6'200.000</p>
        </div>
    </div>
    <div id="description">
        <p id="descr">
            La Gold Foil Telecaster® ofrece un conjunto de características espartanas filtradas en mojo vintage. El mástil de arce en forma de C de mediados de los años 60 y el puente Tele® de 3 selletas con barril de latón picado brindan una sensación auténtica de Fender, mientras que el diapasón de ébano, el cuerpo de caoba y un par de mini-humbuckers Gold Foil crean un estilo y un sonido únicos. Otras características incluyen una pala pintada a juego, clavijero de estilo vintage con botones blancos y 21 trastes Medium Jumbo. Con mucho estilo y ases en el departamento de tonos, la colección Fender Gold Foil combina el encanto perdurable de las guitarras de pedido por correo de mediados de siglo con el estilo y la capacidad de ejecución de un auténtico Fender.
        </p>
        <div id="specific">
            <ul>
                <li>
    ...
    <div id="add">
        <form action="../PHP/agregar_carrito.php" method="post">
            <button name="ejecutarFuncion19" type="submit">Agregar al carrito  <i class="fa-solid fa-basket-shopping"></i></button>
        </form>   
    </div>
    </section>

...
<body>
    ...
    <div id="thinks">
        <div id="container_slider">
            <div id="slider" class="slider"> <!--slider-->
                <div class="sli_section">
                    <img src="../IMG/guitaelec15/guita1.png" alt="" class="sli_img">
                </div>
                <div class="sli_section">
                    <img src="../IMG/guitaelec15/guita2.png" alt="" class="sli_img">
                </div>
                <div class="sli_section">
                    <img src="../IMG/guitaelec15/guita3.png" alt="" class="sli_img">
                </div>
                <div class="sli_section">
                    <img src="../IMG/guitaelec15/guita4.png" alt="" class="sli_img">
                </div>
            </div>
        ...
        <div id="contenide">
                ...
                <p class="infotext">Classic White</p>
                ...
                <p id="infoprice">$12'449.000</p>
        </div>
    </div>
    <div id="description">
        <p id="descr">
            El icónico clásico de los 70 está listo para tomar vuelo nuevamente. Con su diapasón de palisandro encuadernado, mástil SlimTaper™ y un par de humbuckers™ Tribute de los 70 descubiertos, cableados a mano con capacitores Orange Drop®, este Flying V™ está configurado para clavar todos los tonos clásicos de la época. La forma icónica del cuerpo y el clavijero a juego, las perillas reflectoras plateadas y el hardware cromado hacen que esta guitarra esté lista para rockear en cualquier escenario.
        </p>
        <div id="specific">
            <ul>
                <li>
    ...
    <div id="add">
        <form action="../PHP/agregar_carrito.php" method="post">
            <button name="ejecutarFuncion14" type="submit">Agregar al carrito  <i class="fa-solid fa-basket-shopping"></i></button>
        </form>   
    </div>
    </section>

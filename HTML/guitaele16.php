...
<body>
    ...
    <section id="content">
        <div id="tittle">
            <h1>Les Paul Special Tribute - Humbucker</h1>
    ...
    <div id="thinks">
        <div id="container_slider">
            <div id="slider" class="slider"> <!--slider-->
                <div class="sli_section">
                    <img src="../IMG/guitaelec16/guita1.png" alt="" class="sli_img">
                </div>
                <div class="sli_section">
                    <img src="../IMG/guitaelec16/guita2.png" alt="" class="sli_img">
                </div>
                <div class="sli_section">
                    <img src="../IMG/guitaelec16/guita3.png" alt="" class="sli_img">
                </div>
                <div class="sli_section">
                    <img src="../IMG/guitaelec16/guita4.png" alt="" class="sli_img">
                </div>
            </div>
        ...
        <div id="contenide">
                ...
                <p class="infotext">Worn White Satin</p>
                ...
                <p id="infoprice">$4'999.000</p>
        </div>
    </div>
    <div id="description">
        <p id="descr">
            La nueva Gibson Les Paul Special Tribute ofrece a los músicos una nueva versión de un diseño clásico. El tratamiento especial comienza con un cuerpo de caoba equipado con pastillas humbucker de bobina abierta 490R y 490T para tonos ricos y clásicos de Gibson. Los afinadores de botón blancos de lujo vintage y un cordal envolvente compensado mantienen las cosas simples y elegantes. La comodidad y la jugabilidad siempre estarán disponibles gracias al mástil de arce de perfil redondeado y al diapasón de palisandro auténtico. Se podría decir que esta es una entrega especial sónica. Disponible en acabados satinados atemporales: Worn White, Vintage Cherry, Ebony y Natural Walnut.
        </p>
        <div id="specific">
            <ul>
                <li>
                    <span>Forma del cuerpo</span>
                    <p>Les Paul Special</p>
                </li>
                <li>
    ...
    <div id="add">
        <form action="../PHP/agregar_carrito.php" method="post">
            <button name="ejecutarFuncion15" type="submit">Agregar al carrito  <i class="fa-solid fa-basket-shopping"></i></button>
        </form>   
    </div>
    </section>

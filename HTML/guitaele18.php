...
<body>
    ...
    <div id="thinks">
        <div id="container_slider">
            <div id="slider" class="slider"> <!--slider-->
                <div class="sli_section">
                    <img src="../IMG/guitaelec18/guita1.png" alt="" class="sli_img">
                </div>
                <div class="sli_section">
                    <img src="../IMG/guitaelec18/guita2.png" alt="" class="sli_img">
                </div>
                <div class="sli_section">
                    <img src="../IMG/guitaelec18/guita3.png" alt="" class="sli_img">
                </div>
                <div class="sli_section">
                    <img src="../IMG/guitaelec18/guita4.png" alt="" class="sli_img">
                </div>
            </div>
        ...
        <div id="contenide">
                ...
                <p id="infoprice">$39'899.000</p>
        </div>
    </div>
    <div id="description">
        <p id="descr">
            La Gibson EDS-1275 es un diseño icónico que ha capturado la imaginación de fans y músicos durante generaciones.
        </p>
        <div id="specific">
            <ul>
                <li>
                ...
                <li>
                    <span>Pastillas</span>
                    <p>Custombucker Alnico III (Unpotted)</p>
                </li>
            </ul>
        </div>
    </div>
    <div id="add">
        <form action="../PHP/agregar_carrito.php" method="post">
            <button name="ejecutarFuncion17" type="submit">Agregar al carrito  <i class="fa-solid fa-basket-shopping"></i></button>
        </form>   
    </div>
    </section>

...
<body>
    ...
    <section id="content">
        <div id="workshop">
            <h1>Mantenimiento</h1>
            <p>La reparación y mantenimiento constante de nuestro instrumento es de vital importancia para su vida util y en especial, su sonido. Por ello contamos con un taller de mantenimiento aliado llamado <a href="https://www.guitarrascustom.com.co/" target="_blank"><i>Guitarras Custom</i></a> el cual recomendamos para los trabajos de tu instrumento.</p>
            <div id="jobs">
            <h2>Trabajos los cuales se realizan:</h2>
            <ul>
                <li>Reparación, calibración y mantenimiento de guitarras y bajos</li>
                <li>Cambio de micrófonos </li>
                <li>Reparación y mantenimiento de amplificadores</li>
                <li>Diseño y ensamble y mantenimiento de pedaleras</li>
                <li>Reparación y mantenimiento de pedales</li>
            </ul>
            <iframe width="560" height="315" src="https://www.youtube.com/embed/yOfHp-3I0HE" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
            </div>
        </div>
    </section>
